...
function refreshSettings(settings) {
    var blackoutGroup = document.getElementById('blackoutGroup');

    if (settings) {
        blackoutGroup.value = settings.selectedValue;
    }

    blackoutGroup.disabled = false;
}
...
function updateSettings() {
    ...
    setSettings.payload = {};
    setSettings.payload.selectedValue = blackoutGroup.value;
