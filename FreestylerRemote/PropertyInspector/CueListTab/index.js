...
function refreshSettings(settings) {
    var selectCueListTab = document.getElementById('selectCueListTab');

    if (settings) {
        selectCueListTab.value = settings.selectedValue;
    }

    selectCueListTab.disabled = false;
}
...
function updateSettings() {
    ...
    setSettings.payload = {};
    setSettings.payload.selectedValue = selectCueListTab.value;
