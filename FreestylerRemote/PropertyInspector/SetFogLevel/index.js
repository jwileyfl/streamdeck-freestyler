...
function refreshSettings(settings) {
    ...
    if (settings) {
        selectValue.value = settings.selectedValue;

        aValueSlider && Array.prototype.forEach.call(aValueSlider, function (ctl) {
            ctl.value = settings.selectedValue;
        })

        valueBox.value = settings.selectedValue;
    }
...
function updateSettings() {
    ...
    valueBox.value = selectValue.value;

    var setSettings = {};
    setSettings.event = 'setSettings';
    setSettings.context = uuid;
    setSettings.payload = {};
    setSettings.payload.selectedValue = selectValue.value;
