...
function refreshSettings(settings) {
    var selectCueList = document.getElementById('selectCueList');

    if (settings) {
        selectCueList.value = settings.selectedValue;
    }

    selectCueList.disabled = false;
}
...
function updateSettings() {
    ...
    setSettings.payload = {};
    setSettings.payload.selectedValue = selectCueList.value;
