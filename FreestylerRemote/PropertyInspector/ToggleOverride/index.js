...
function refreshSettings(settings) {
    var selectOverrideButton = document.getElementById('selectOverrideButton');

    if (settings) {
        selectOverrideButton.value = settings.selectedValue;
    }

    selectOverrideButton.disabled = false;
}
...
function updateSettings() {
    ...
    setSettings.payload = {};
    setSettings.payload.selectedValue = selectOverrideButton.value;
