...
function refreshSettings(settings) {
    var selectOverrideTab = document.getElementById('selectOverrideTab');

    if (settings) {
        selectOverrideTab.value = settings.selectedValue;
    }

    selectOverrideTab.disabled = false;
}
...
function updateSettings() {
    ...
    setSettings.payload = {};
    setSettings.payload.selectedValue = selectOverrideTab.value;
